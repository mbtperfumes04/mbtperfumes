...
import 'package:mbtperfumes/controllers/purchase_controller.dart';
    ...
    return PaypalCheckoutView(
        ...
        onSuccess: (Map params) async {
          ...
          if(result.isNotEmpty) {
            final purchaseEmailStatus = await PurchaseController().sendEmail(order: result['order'], orderItems: result['items']);
